...
> Notes:
> * The `defer` attribute lets you put the script tag wherever you want, otherwise the script might run (activate) before the rest of the HTML is finished loading, possibly causing an error.
